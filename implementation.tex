...
\code{CyclusVersionDescribe} & \code{VL_STRING} & Detailed \Cyclus version info 
                                                  (with commit hash).\\
\code{SqliteVersion} & \code{VL_STRING} & \\
\code{Hdf5Version} & \code{VL_STRING} & \\
\code{BoostVersion} & \code{VL_STRING} & \\
\code{LibXML2Version} & \code{VL_STRING} & \\
\code{CoinCBCVersion} & \code{VL_STRING} & \\
\hline
\end{tabular}
\end{table}
