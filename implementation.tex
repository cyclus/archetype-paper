...
a distinction between fixed-length and \gls{VL} versions. Thus even the 
...
forth between \gls{JSON} types and C++ types as need. It provides as fully introspectible 
...
implemented using robus schema validation with \acrlong{XML} and \acrlong{RNG}.
