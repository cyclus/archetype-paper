...
plug in user-created archetypes implies a programing contract (API) where 
...
Since implementing this part of the archetype API is both highly error-prone and 
...
known structure called a \emph{schema}. The schema is itself XML that describes 
...
are written in: XML itself and the schema interface. This provides additional 
...
XML-based schema are extraordinarily useful as mechanism for validating types. 
